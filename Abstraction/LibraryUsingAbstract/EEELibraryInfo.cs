...
{
    public class EEELibraryInfo : LibraryInfo
    {
        //creating the properties for EEELibraryInfo 
        ...
        {
            currentObject = new EEELibraryInfo(authorName, bookName, publisherName, year);

        }
        //creating  the empty constructor
        public EEELibraryInfo() { }
        //creating the parameterized constructor
        public EEELibraryInfo(string authorName, string bookName, string publisherName, int year) : base(true)
        {
