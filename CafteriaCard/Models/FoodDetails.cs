...
namespace CafeteriaCard.Models
{
    public class FoodDetails
    {
        ...
        /// <summary>
        /// Property used to store Price <see cref="FoodDetails"/>
        /// </summary>
        ...
        /// <param name="price">price is a double used to initialize the property price</param>
        /// <param name="quantityAvailable">quantityAvailable is a string used to initialize the property quantityAvailable</param>
        public FoodDetails(string foodID, string foodName, double price, int quantityAvailable)
        {
            FoodID = foodID;
            FoodName = foodName;
            Price = price;
        ...
        /// <param name="quantityAvailable">quantityAvailable is a string used to initialize the property quantityAvailable</param>
        public FoodDetails(string foodName, double price, int quantityAvailable)
        {
            FoodID = $"FID{++s_foodID}";
            FoodName = foodName;
            Price = price;
