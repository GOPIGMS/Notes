...
namespace StudentsDetailInfo
{
    public class StudentInfo : PersonalInfo
    {
        ...
        public StudentInfo(int registerNumber, string name, string fatherName, string phone, string mail, DateTime dob, GenderDetails gender, string standard, string branch, int acadamicYear) : base(name, fatherName, phone, mail, dob, gender)
        {
